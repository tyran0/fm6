<div id="svg-atlas" hidden>
    <svg xmlns="http://www.w3.org/2000/svg">
        <defs>
            <symbol id="svg_icon-cart">
                <!--
                    width       22
                    height      20
                -->
